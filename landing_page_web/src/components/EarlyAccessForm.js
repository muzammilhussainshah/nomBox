...
class EarlyAccessForm extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h2 style={{ marginBottom: "5%", fontFamily: Font }}>Sign Up for Early Access</h2>
...
const invalidRadio = { margin: "0 auto", marginBottom: '5%', backgroundColor: '#fff', borderRadius: 18, paddingTop: 6, width: '60%', border: '1px solid red', display: 'flex', justifyContent: 'center' };
export { focusVar }